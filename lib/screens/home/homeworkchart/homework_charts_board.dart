...
class HomeWorkChartsBoard extends StatefulWidget {
  @override
  _HomeWorkChartsBoardState createState() => _HomeWorkChartsBoardState();
}

class _HomeWorkChartsBoardState extends State<HomeWorkChartsBoard> {
  @override
  void dispose() {
    super.dispose();
  }
