...
class StudyBoardScreen extends StatefulWidget {
  @override
  StudyBoardScreenState createState() => StudyBoardScreenState();
}

class StudyBoardScreenState extends State<StudyBoardScreen>
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: TabBarView(
                controller: this._tabController,
                children: <Widget>[HomeWorkBriefCharts(), Container()]),
          )
        ],
      ),
    );
