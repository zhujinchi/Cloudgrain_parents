...
class StudyPlanChartsBoard extends StatefulWidget {
  @override
  _StudyPlanChartsBoardState createState() => _StudyPlanChartsBoardState();
}

class _StudyPlanChartsBoardState extends State<StudyPlanChartsBoard> {
  @override
  void dispose() {
    super.dispose();
  }
