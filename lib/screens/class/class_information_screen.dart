...
class ClassInformationScreen extends StatefulWidget {
  ...
  @override
  ClassInformationScreenState createState() => ClassInformationScreenState();
}

class ClassInformationScreenState extends State<ClassInformationScreen>
      ...
      child: Column(
        ...
        children: <Widget>[
          Container(
            ...
            //后期代码优化
            padding: EdgeInsets.only(top: 16.w, right: 140.w),
            width: 375.w,
            height: 46.w,
            child: TabBar(
                isScrollable: true,
    ...
    return Container(
      child: Stack(
        children: <Widget>[
          ...
          Padding(
            padding: EdgeInsets.only(left: 300.w, top: 490.h),
            child: Container(
              //color: Colors.red,
              width: 64.w,
              height: 28.w,
